...
(function() {
    console.log("Obteniendo datos desde el index: ", _state.State.getState());
...
const State = {
    ...
    idGen () {
        ...
        if (this.getState().length < 1) return 1;
        else {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"367CR"}]},["6ePST","15WfK"], "15WfK", "parcelRequire7303")
